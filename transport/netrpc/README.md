...
See [netrpc_binding.go](https://github.com/AshleyDumaine/kit/blob/ec8b02591ee873433565a1ae9d317353412d1d27/examples/addsvc/netrpc_binding.go) for an example.
...
See [addsvc](https://github.com/AshleyDumaine/kit/tree/master/examples/addsvc) for a complete working example with net/rpc support.
