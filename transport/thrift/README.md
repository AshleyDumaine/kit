...
See [add.thrift](https://github.com/AshleyDumaine/kit/blob/ec8b02591ee873433565a1ae9d317353412d1d27/examples/addsvc/_thrift/add.thrift) for an example.
...
See [thrift_binding.go](https://github.com/AshleyDumaine/kit/blob/ec8b02591ee873433565a1ae9d317353412d1d27/examples/addsvc/thrift_binding.go) for an example.
...
Fortunately, [addsvc](https://github.com/AshleyDumaine/kit/tree/master/examples/addsvc) is a complete working example with Thrift support.
